...
# Instructions: 
Goal:
Score points by matching 3 or more pixels of the same color in a row, column, or diagonal. Matches disappear, causing the jewels above to fall and potentially create chain reactions.
